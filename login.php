        ...
        if (mysqli_num_rows($result)>0) {
             while ($row=mysqli_fetch_array($result)) {
                $_SESSION['LoginAdmin']=$row["Email"];
                 echo"<script>  alert('  Login has been  successfully    '); window.location.href='admin/index.php'; </script> ";
            }
       	  ...
       	  echo"<script>  alert(' There was an error in Login process Make sure Your infor  ');window.location.href='login.php' </script> ";
        }
...
.p-1{
  align-content: center;
   ...
   body{
     ...
     <?php $path='./assets'; include("include/header.php")?>
