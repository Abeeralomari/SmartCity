 ...
 <style>
    ...
    .text-center .more-btn {
        ...
        #main{
            background: url(./assets/img/INT.jpg) top center;
       ...
       <div class="col-lg-12">
              <div class="row">
                <div class="col-lg-4 d-flex align-items-stretch">
                  <div class="content">
                        <div class="text-center">
                           <a href="Video.php" class="text-center more-btn">CLICK ON A VIDEO </a>
                        </div>
                  </div>
               </div>
              <div class="col-lg-4 d-flex align-items-stretch">
                    <div class="content">
                        <div class="text-center">
                            <a href="Images.php" class="more-btn">CLICK ON IMAGES</a>
                      </div>
                    </div>
              </div>
              <div class="col-lg-4 d-flex align-items-stretch ">
                     <div class="content"> 
                          <div class="text-center">
                             <a href="Links.php" class="more-btn" style="">CLICK ON THE LINKS</a>
                          </div>    
                      </div>
               </div>
        </div>
